 ...
 */
public class MySupportDialogFragment extends PermissionBaseDialogFragment implements ISupportFragment {
    ...
    public <T extends MySupportDialogFragment> T getParentDelegate() {
    ...
    public void popAllTopFragment() {
        MySupportDialogFragment topFragment = (MySupportDialogFragment) getTopFragment();
        if (topFragment != null && topFragment != this) {
            topFragment.pop();
            MySupportDialogFragment preFragment = (MySupportDialogFragment) topFragment.getPreFragment();
            while (preFragment != null && preFragment != this) {
                preFragment.pop();
                preFragment = (MySupportDialogFragment) preFragment.getPreFragment();
            }
        }
    }
}
