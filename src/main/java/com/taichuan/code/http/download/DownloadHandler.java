...
public class DownloadHandler {
    ...
    public DownloadHandler(String url,
                           ...
                           IError error,
                           RestClientBuilder.OnDownLoadProgress onDownLoadProgress) {
        this(url, headers, params, dir, null, name, request, success, error, onDownLoadProgress);
    }
    ...
    public DownloadHandler(String url,
                           ...
                           IError error,
                           RestClientBuilder.OnDownLoadProgress onDownLoadProgress) {
        this(url, headers, params, dir, extension, null, request, success, error, onDownLoadProgress);
    }


    public void handleDownload() {
        Call<ResponseBody> call = RestCreator.getRestService().download(URL, HEADERS, PARAMS);
        if (call != null) {
            if (REQUEST != null) {
