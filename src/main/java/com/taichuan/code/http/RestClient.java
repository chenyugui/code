...
public class RestClient {
    ...
    protected final LinkedHashMap<String, Object> HEADERS;
    ...
    private Call<String> getCall(HttpMethod method) {
        ...
        switch (method) {
            case GET:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).get(URL, HEADERS, PARAMS);
                break;
            case POST:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).post(URL, HEADERS, PARAMS);
                break;
            case POST_MULTIPART:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).postMultipart(URL, HEADERS, changeParamToRequestBody(PARAMS));
                break;
            case POST_RAW:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).postRaw(URL, HEADERS, BODY);
                break;
            case DELETE:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).delete(URL, HEADERS, PARAMS);
                break;
            case PUT:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).put(URL, HEADERS, PARAMS);
                break;
            case PATCH:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).patch(URL, HEADERS, PARAMS);
                break;
            case PUT_RAW:
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).putRaw(URL, HEADERS, BODY);
                break;
            case UPLOAD:
                ...
                call = RestCreator.getRestService(TIME_OUT, mInterceptorList).upload(URL, HEADERS, body);
                break;
            default:
                break;
        }
