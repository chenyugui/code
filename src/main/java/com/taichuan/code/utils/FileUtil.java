...
public class FileUtil {
    ...
    public static boolean writeStringToNewFile(String content, String fileDir, String fileName) {
        ...
        return writeStringToFile(content, fileDir, fileName);
    }

    /**
     * 将字符串写入文件里
     */
    public static boolean writeStringToFile(String content, String fileDir, String fileName) {
    ...
    public static void writeCrashInfoToFile(Throwable ex, String fileDir, String fileName) {
        ...
        FileUtil.writeStringToFile(sb.toString(), fileDir, fileName);
    }
